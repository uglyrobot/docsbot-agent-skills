...
| --- | --- | --- | --- |
| DocsBot Admin MCP | `https://mcp.docsbot.ai` | `search`, `execute` | Administering DocsBot teams, bots, sources, members, billing settings, integrations, Skills, and reporting through existing dashboard permissions. |
...
This package is for **DocsBot Admin MCP**.
...
Admin MCP uses browser-based OAuth. Authorized clients can be reviewed and revoked from **API & Integrations** in the DocsBot dashboard.
