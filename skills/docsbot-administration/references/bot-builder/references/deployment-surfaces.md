...
| Slack | Internal team assistant or Slack app surface | Load [slack-deployment.md](slack-deployment.md). User must complete OAuth outside MCP, usually from the API/Integrations dashboard. Verify Slack bot mapping after install. |
...
- For Help Scout, load [helpscout-auto-drafting.md](helpscout-auto-drafting.md). For Slack, load [slack-deployment.md](slack-deployment.md) and treat OAuth/install and workspace selection as user-completed even when MCP can generate the authorize URL.
